...
class AppDialog : AppCompatDialogFragment() {
    ...
    /**
     * The dialogues callback interface, to notify of user selected results (deletion confirmed, etc.).
     */
...
//        fun onDialogCancelled(dialogId: Int)
    ...
    override fun onAttach(context: Context) {
        ...
        dialogEvents = try {
            ...
            try {
                ...
                throw ClassCastException("Activity $parentFragment must implement AppDialog.DialogEvents inteface")
            }
        }
        catch(e: ClassCastException) {
            // Activity doesn't implement the interface
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        // fix "smart cast to Bundle is impossible, because the arguments is a mutable property that could have been changed by this time
        ...
        return builder.setMessage(messageString)
            ...
            .setNegativeButton(negativeStringId) { dialogInterface, which ->
                ...
                // dialogueEvents?.onNegativeDialogueResult(dialogId, arguements)
            }
            .create()
    ...
    override fun onDetach() {
        ...
        // Reset the active callbacks interface, beacuse we're no longer attached.
        dialogEvents = null
    }
...
//        dialogEvents?.onDialogCancelled(dialogId)
    ...
    override fun onDismiss(dialog: DialogInterface) {
        ...
        super.onDismiss(dialog) // <----- comment this line out for strange results
    }
}